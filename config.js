module.exports = {
  OWNER_IDS: [622541038531379220], // Bot owner ID's
  PREFIX: "!", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/T924ZfTuHF", // Your bot support server
  PRESENCE: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1003081526780637206", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
